    ...
    return (
        <section className='my-12 container mx-auto'>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-20 mt-20">
                <div className="bg-gray-100 w-full mx-auto text-primary font-bold border-2 shadow-xl border-secondary rounded-tr-full rounded-tl-full text-center relative h-16 hover:scale-110 transition-transform duration-300 ease-in-out cursor-pointer">
