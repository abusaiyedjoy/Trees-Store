...
const SignUp = () => {
  ...
  return (
    <section className="flex flex-col w-full">
      <Helmet>
        <title>Trees Store || Sign Up</title>
      </Helmet>
      ...
      <div className="w-full max-w-lg mx-auto p-8 my-12 border-2 shadow-md space-y-3 rounded-xl bg-gray-50 text-gray-800">
        ...
        <div className="flex justify-center space-x-4">
          <button
            ...
            className="p-3 bg-green-500 hover:bg-green-600 hover:scale-105 rounded-full text-white"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 32 32"
